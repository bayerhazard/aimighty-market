...
- Upstream project: https://github.com/nesquena/hermes-webui (MIT)`,
      upgradeDescription:
        `v1.0.1: Migrated OlaresManifest to apiVersion v3 / CfgFileVersion 0.12.0 (required by Olares 1.12 app-service; v2 manifests are rejected at install). v1.0.0: Initial release — hermes-webui 0.50.43 in-process on the shared HERMES_HOME, zero changes to Hermes Agent.`,
      categories: ["AI"],
      developer: "Aimighty",
