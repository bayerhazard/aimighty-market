...
- **Local & Secure** – full data sovereignty; emails and AI models remain exclusively local on your device.`,
        upgradeDescription:
                    `v26.9.140: AI Assistant v2 — ask in plain language about your calendar, contacts, tasks and mail; the agent proposes actions as reviewable plans that you confirm before anything is written. Built for Olares 1.12.6.`,
      categories: ["Utilities"],
