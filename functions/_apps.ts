...
CPU: 4-16 cores`,
      upgradeDescription:
        `v26.08.16: NVFP4 weights (unsloth) + NVFP4 KV cache (--kv-cache-dtype nvfp4). Weights ~15 GiB + KV halved (~2.4 GiB vs 4.7) → headroom for CUDA graph capture (26.08.14 OOM'd with fp8-KV at 22.77/23.42 GiB). Performance without MTP. Built for Olares 1.12.6.
