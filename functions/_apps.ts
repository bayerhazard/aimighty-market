...
CPU: 4-16 cores`,
      upgradeDescription:
        `v26.08.6: vLLM v0.26.0-cu129 + MTP + enforce-eager (torch.compile crashes with Gemma4-MoE+MTP on v0.26.0 — enforce-eager disables Dynamo/CUDAGraphs). Test: 200K+MTP. Built for Olares 1.12.6.
