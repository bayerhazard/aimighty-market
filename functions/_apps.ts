...
- **Local & Secure** – full data sovereignty; emails and AI models remain exclusively local on your device.`,
        upgradeDescription:
                    `v26.9.133: Server-first speed: dual IMAP connections, instant move/delete/read (background provider sync), batched EXPUNGE, pre-generated AI followups. Built for Olares 1.12.6.`,
      categories: ["Utilities"],
