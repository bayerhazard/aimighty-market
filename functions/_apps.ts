...
**Note:** Model weights are CC-BY-NC-4.0 (non-commercial use only).`,
  ...
  },
  {
    metadata: {
      ...
      description: { en: "Qwen3.6-27B with BeeLLama.cpp + DFlash IQ4_XS + kvarn4 KV — Prompt-Cache enabled (--cache-ram -1, --cache-reuse 256), temp 0.6, Threads 16" },
      fullDescription:
        `**aimqwen36llama** — Qwen3.6-27B with BeeLLama.cpp + DFlash IQ4_XS + kvarn4 KV.
