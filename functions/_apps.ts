...
- **Local & Secure** – full data sovereignty; emails and AI models remain exclusively local on your device.`,
        upgradeDescription:
                    `v26.9.129: Instant message body (short-circuit + optimistic preview + 25x pre-fetch). Instant load (cache-first init <500ms). WYSIWYG compose. Built for Olares 1.12.6.`,
      categories: ["Utilities"],
