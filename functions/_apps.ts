...
IMAP/SMTP-Anbindung mit lokalem Cache und KI-Assistenz (Antworten, Zusammenfassungen, Prioritäten, Tonfall).`,
      upgradeDescription:
        `v26.09.49: FIX Kontextmenü-Position (list-pane/preview-pane contain: layout entfernt — fixed-Menüs waren versetzt); lokale Ordner ohne führendes Ordnersymbol; Kontakte-Icon in den Einstellungen ersetzt (war kaputt).
