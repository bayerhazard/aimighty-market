...
IMAP/SMTP-Anbindung mit lokalem Cache und KI-Assistenz (Antworten, Zusammenfassungen, Prioritäten, Tonfall).`,
      upgradeDescription:
        `v26.09.50: FIX Anhänge öffnen/speichern (loadAttachmentContent lieferte das JSON-Objekt statt des Content-Strings -> atob-Fehler "invalid characters"); NEU: Cache -> "Alle KI-Zusammenfassungen löschen" (regeneriert Summations).
