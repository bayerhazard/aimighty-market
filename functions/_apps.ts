...
CPU: 4-16 cores`,
      upgradeDescription:
        `v26.08.17: NVFP4 KV fix — attention backend flash_attn (triton_attn rejects nvfp4-KV: 'kv_cache_dtype not supported'). NVFP4 weights + nvfp4 KV. Built for Olares 1.12.6.
