...
IMAP/SMTP-Anbindung mit lokalem Cache und KI-Assistenz (Antworten, Zusammenfassungen, Prioritäten, Tonfall).`,
      upgradeDescription:
        `v26.09.45: MBOX-Import: Apple-Mail-Export-Struktur unterstützt (Verzeichnis X.mbox mit Datei "mbox" darin, verschachtelte Ordner wie "Beta Tests/Ecovacs Goat" -> lokaler Ordner "Beta Tests.Ecovacs Goat"). Import via /import/mbox-dir aus /data/Relay/Mails.
