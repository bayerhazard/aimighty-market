...
IMAP/SMTP-Anbindung mit lokalem Cache und KI-Assistenz (Antworten, Zusammenfassungen, Prioritäten, Tonfall).`,
      upgradeDescription:
        `v26.09.51: Spam-Ordner wird wie jeder andere Ordner behandelt (gecacht + angezeigt); "Gesendet"/"Sent" ist jetzt ein LOKALER Ordner (volle Historie lokal, kein IMAP-Abgleich/Prune — Senden bleibt lokal im Archiv-Modus).
