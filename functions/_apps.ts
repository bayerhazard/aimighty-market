...
CPU: 4-16 cores`,
      upgradeDescription:
        `v26.08.7: vLLM v0.26.0-cu129, MTP removed (draft model collides with Gemma4-MoE at memory profiling: mat-shape 3840 vs 5632). enforce-eager (torch.compile crashes too). Test: 200K + skip-layers sliding_window on new per-KV-group logic. Built for Olares 1.12.6.
