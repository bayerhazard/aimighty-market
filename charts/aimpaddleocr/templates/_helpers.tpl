...
{{- define "aimpaddleocr.isBlackwell" -}}
{{- $is := "false" -}}
...
{{- define "aimpaddleocr.engineImage" -}}
{{- if eq (include "aimpaddleocr.isBlackwell" .) "true" -}}
